          ...
          <CardContent className="p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-base">
                ...
                definition of health goes beyond the absence of disease, stating
                that health is a state of complete physical, mental, and social
                well-being. This holistic perspective is foundational to
                understanding child health today.
                <sup>
              ...
              <p className="text-base">
                ...
                The CDC emphasizes that a healthy child is one who is supported
                in all areas—physical, mental, and emotional—to ensure optimal
                development.
                <sup>
                  <a href="#footnote-2" className="text-blue-600">
                    [2]
                  </a>
                </sup>
              </p>
              ...
              <p className="text-base">
                <strong>Developmental Psychology Research:</strong> Studies in
                child development stress that nurturing emotional intelligence,
                social skills, and spiritual growth is just as important as
                physical health for building resilience and long-term success.
                <sup>
                  <a href="#footnote-3" className="text-blue-600">
                    [3]
                  </a>
                </sup>
              </p>
              ...
              <p className="text-base italic">
                <strong>Luke 2:52:</strong> "And Jesus grew in wisdom, stature,
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-800">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li id="footnote-1">
              ...
              <em>Constitution of the World Health Organization</em>. Retrieved
              from{" "}
              <a
