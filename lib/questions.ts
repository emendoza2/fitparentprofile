...
export const dimensionColors = {
  "TRUTH-SEEKING": {
    ...
    bg: "bg-orange-200",
    bgTranslucent: "bg-orange-200/50",
    bgLight: "bg-orange-100",
    border: "border-orange-800",
    fill: "fill-orange-800 dark:fill-orange-400",
    nativeColor: resolveColor("orange-400"),
    fillOpacity: 0.5,
  ...
  TEACHING: {
    ...
    bg: "bg-green-300",
    bgTranslucent: "bg-green-300/50",
    bgLight: "bg-green-200",
    border: "border-green-800",
    fill: "fill-green-800 dark:fill-green-400",
    nativeColor: resolveColor("green-500"),
    fillOpacity: 0.5,
  ...
  TRAINING: {
    ...
    bg: "bg-brown-300",
    bgTranslucent: "bg-brown-300/50",
    bgLight: "bg-brown-200",
    border: "border-brown-800",
    fill: "fill-brown-800 dark:fill-brown-400",
    nativeColor: resolveColor("brown-500"),
    fillOpacity: 0.5,
  ...
  PEACEMAKING: {
    ...
    bg: "bg-blue-300",
    bgTranslucent: "bg-blue-300/50",
    bgLight: "bg-blue-200",
    border: "border-blue-800",
    fill: "fill-blue-800 dark:fill-blue-400",
    nativeColor: resolveColor("blue-500"),
    fillOpacity: 0.5,
  ...
  ENTRUSTING: {
    ...
    bg: "bg-champagne-300",
    bgTranslucent: "bg-champagne-300/50",
    bgLight: "bg-champagne-200",
    border: "border-champagne-800",
    fill: "fill-champagne-800 dark:fill-champagne-400",
    nativeColor: resolveColor("champagne-500"),
    fillOpacity: 0.5,
